    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruit pies", "A pie is a baked dish which is usually made of a pastry dough casing that contains a filling of various sweet or savoury ingredients" },
                    { 2, "Cheese cakes", "Blueberry pie is a pie with a blueberry filling." },
                    { 3, "Seasonal pies", "On top of the seasonal chart and recipes the great post also offers up information on the different kinds of pies that can be made" }
                });

            migrationBuilder.InsertData(
                table: "team",
                columns: new[] { "TeamId", "ImageThumbnailUrl", "Name", "ShortDescription" },
                values: new object[,]
                {
                    { 1, "https://gillcleerenpluralsight.blob.core.windows.net/files/applepiesmall.jpg", "Sneha sinha", "" },
                    { 2, "https://gillcleerenpluralsight.blob.core.windows.net/files/applepiesmall.jpg", "Vaibhav Bhatngara", "Hard" },
                    { 3, "https://gillcleerenpluralsight.blob.core.windows.net/files/applepiesmall.jpg", "Subhash Gurjar", "working" },
                    { 4, "https://gillcleerenpluralsight.blob.core.windows.net/files/applepiesmall.jpg", "Simran singh", "Smart" }
                });
